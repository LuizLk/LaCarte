 ...
 */
function OrmTreeRepository(cls, connectionName = "default") {
    return function (object, propertyName, index) {
        typedi_1.Container.registerHandler({ object, index, propertyName, value: () => {
                ...
                return connection.getTreeRepository(cls);
            } });
    };
}
exports.OrmTreeRepository = OrmTreeRepository;
//# sourceMappingURL=OrmTreeRepository.js.map